...
public class DecryptionResultHandlerInteractiveBiometricManualRetry extends DecryptionResultHandlerInteractiveBiometric {
  private BiometricPrompt presentedPrompt;
  private Boolean didFailBiometric = false;

  public DecryptionResultHandlerInteractiveBiometricManualRetry(@NonNull Context AContext,
                                                                @NonNull CipherStorage storage,
                                                                @NonNull BiometricPrompt.PromptInfo promptInfo) {
    super(AContext, storage, promptInfo);
  }
